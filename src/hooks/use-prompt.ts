 ...
 * @source referenced from: https://github.com/remix-run/react-router/issues/8139#issuecomment-1023105785
 */
...
/**
 * Blocks the navigation with an window alert `message` if `when` is true.
 *
...
/**
 * Perform a transition (i.e. Blocker) when navigation is blocked.
 *
