...
//     const { container } = render(<BaseSearchBar s />);
//     const input = getSearchBarInput(container);
//     expect(input).toHaveAttribute('type', 'text');
//   });

//   it('should render placeholder', () => {
//     const { container } = render(<BaseSearchBar placeholder={TEST_PLACEHOLDER} />);
...
//       <BaseSearchBar placeholder={TEST_PLACEHOLDER} initialText={TEST_INITIAL_TEXT} />
//     );
//     const input = getSearchBarInput(container);
...
//     const { container } = render(<BaseSearchBar />);
...
//     const { container } = render(<BaseSearchBar dropDownData={TEST_OPTIONS_SINGLE} />);
//     const input = getSearchBarInput(container);
...
//     const { container } = render(<BaseSearchBar dropDownData={TEST_OPTIONS_SMALL} />);
//     const input = getSearchBarInput(container);
...
//     const { container } = render(
//       <BaseSearchBar dropDownData={TEST_OPTIONS_SINGLE} onEnterPressed={mockOnEnter} />
//     );
//     const input = getSearchBarInput(container);
...
//     const { container } = render(
//       <BaseSearchBar dropDownData={TEST_OPTIONS_SINGLE} onChange={mockOnChange} />
//     );
//     const input = getSearchBarInput(container);
