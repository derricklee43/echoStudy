...
describe('Flashcard', () => {
  ...
  //   render(<StudyFlashcard variant="inactive" card={testCard} />);
  ...
  //   const testCard = getTestFoxCard();
  //   render(<StudyFlashcard variant="active" card={testCard} />);
  //   expect(screen.queryByDisplayValue(testCard.front.text)).toBeInTheDocument();
  //   expect(screen.queryByDisplayValue(testCard.back.text)).toBeInTheDocument();
  //   expect(screen.queryAllByRole('button', { name: 'speaker' }).length).toEqual(0);
  ...
  //   const testCard = getTestFoxCard();
  //   render(<StudyFlashcard variant="readonly" card={testCard} />);
  //   expect(screen.queryByDisplayValue(testCard.front.text)).toBeInTheDocument();
  //   expect(screen.queryByDisplayValue(testCard.back.text)).toBeInTheDocument();
  ...
  //   render(<StudyFlashcard variant="active" card={createNewCard()} />);
  ...
  //   render(<StudyFlashcard variant="active" card={card} onCardChange={mockOnCardChange} />);
