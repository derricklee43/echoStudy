...
import { PlayerOptionsPopup } from './player-options-popup/player-options-popup';
...
export const AudioControlBar = ({
  ...
  return (
    <>
      <PlayerOptionsPopup showPopup={showOptionsPopup} onClose={() => setShowOptionsPopup(false)} />
